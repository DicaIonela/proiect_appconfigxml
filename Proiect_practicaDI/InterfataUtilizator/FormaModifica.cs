...
{
    public partial class FormaModifica : Form
    {
        ...
        public FormaModifica(string numeOriginal)
        {
        ...
        public int Validare()
        {
            ...
            if (txtNume.Text.Length > 25 || txtNr.Text.Length > 13 || txtAdresa.Text.Length > 22)
            {
                return 1;
            }
            if (txtNr.Text.StartsWith("+40"))
            {
                ...
                {
                    txtNr.Text = "004" + txtNr.Text.Substring(2);
                    return 5; /*Valid*/
                }
            }
            if (txtNr.Text.Length == 10 && txtNr.Text.All(char.IsDigit) && txtNr.Text.StartsWith("0"))
            {
                txtNr.Text = "004" + txtNr.Text;
                return 5; /*Adaugam prefixul +4 -> 0 fiind deja inclus*/
            }
            if (txtNr.Text.Length == 14 && txtNr.Text.All(char.IsDigit) && txtNr.Text.StartsWith("0040"))
            {
                return 5;
            }
            else
